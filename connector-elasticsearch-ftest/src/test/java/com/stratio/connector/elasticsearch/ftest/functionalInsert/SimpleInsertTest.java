...
public class SimpleInsertTest extends ConnectionTest {
    ...
    @Test
    public void testSimpleInsert() throws ExecutionException, ValidationException, UnsupportedOperationException {
        ...
        for(SearchHit hit: hits.hits()){
        	 assertEquals("The value is correct", "value1", hit.getSource().get("name1"));
        	 assertEquals("The value is correct", 2, hit.getSource().get("name2"));
        	 assertEquals("The value is correct", true, hit.getSource().get("name3"));
        }
        
        assertEquals("The records number is correct", 1, hits.totalHits());
